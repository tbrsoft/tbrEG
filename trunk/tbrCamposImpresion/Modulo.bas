...
Public Function SelectForm(pHoja As Hoja, ByVal MyhWnd As Long) _
    As Integer
...
If OpenPrinter(PrinterName, PrinterHandle, 0&) Then
    ...
    If FormName = "tbrCustomForm" Then
        ...
        If GetFormName(PrinterHandle, FormSize, FormName) = 0 Then
            ...
            AddNewForm PrinterHandle, FormSize, "tbrCustomForm"
            If GetFormName(PrinterHandle, FormSize, FormName) = 0 Then
